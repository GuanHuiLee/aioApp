...
public class FolderAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ViewHolder holder;
        if (view == null) {
            view = mInflater.inflate(R.layout.item_fol, viewGroup, false);
        ...
        if (holder != null) {
            if (i == 0) {
                ...
                if (mFolders.size() > 0) {
                    ...
                    GlideHelper.loadSizeImage(mContext, holder.cover, new File(f.cover.path), mImageSize, mImageSize);
                }
            } else {
    ...
    class ViewHolder {
        ...
        void bindData(Folder data) {
            ...
            GlideHelper.loadSizeImage(mContext, cover, new File(data.cover.path),mImageSize,mImageSize);
        }
    }
