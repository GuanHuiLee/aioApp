...
/**
 * Created by LiGuanHui on 2018/11/27 09:34
...
import com.zgg.commonlibrary.banner.adapter.CBPageAdapter;
import com.zgg.commonlibrary.banner.holder.CBViewHolderCreator;
import com.zgg.commonlibrary.banner.listener.CBPageChangeListener;
import com.zgg.commonlibrary.banner.listener.OnItemClickListener;
...
public class ConvenientBanner<T> extends LinearLayout {
    ...
    public ConvenientBanner setPageIndicator(int[] page_indicatorId) {
        ...
        for (int count = 0; count < mDatas.size(); count++) {
            ...
            pointView.setPadding(5, 0, 10, 0);
            if (mPointViews.isEmpty())//第一张选中
